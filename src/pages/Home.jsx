...
export default function Home() {
  ...
  const quickLinks = [
    { img: githubLogo, title: 'GitHub', link: 'https://github.com/Manvij2806' },
    { img: linkedinLogo, title: 'LinkedIn', link: 'https://www.linkedin.com/in/manvi-jain-457183339/' },
    { img: gmailLogo, title: 'Email', link: 'mailto:jainmanvi004@gmail.com' },
  ]
      ...
      <div className="home-top">
        ...
        >
          ...
          <p className="typing-effect">
             Full Stack Developer | AI/ML Explorer | Tech Explorer
          </p>
          ...
          <motion.div className="info-cards">
            {[
              ...
              { label: '💼 Expertise', value: 'Full Stack Development, Problem Solving' },
              { label: '📧 Contact', value: 'jainmanvi004@gmail.com' },
            ].map((info, i) => (
